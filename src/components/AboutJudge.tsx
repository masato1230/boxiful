          ...
          <div className="rounded-lg shadow-xl bg-white p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <p>
                  　上手く判定されない時は、これら２つの点を意識してみてください。
                </p>
                <p>
                  　パンチやキックの合間はしっかりと両手を胸の前で構えて、すぐにパンチを繰り出せるようにするのがポイントです。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg shadow-xl bg-white p-6">
            <div className="items-center flex justify-center flex-wrap-reverse">
              <div className="md:w-1/2 px-1">
                ...
                <p>
                  　キックをするときは、蹴り出す足の反対側の腕を振り出しながら蹴ってみるのがポイントです。
                </p>
              </div>
              <img
          ...
          <div className="rounded-lg shadow-xl bg-white p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <p>
                  　サイトがカメラを利用するのを禁止している場合は、メニュー選択をもう一度してください。メニューを選択すると、このサイトがカメラを利用するのを許可するかどうかのダイアログが表示されるので、許可してください。
                </p>
                <p>
                  　iPhone,
                  iPadといったiOS端末ではAIが上手く動作しない可能性が高いです。また、CPUの性能が低いデバイスでもAIが動作しない可能性が高いです。
                </p>
              </div>
            </div>
          </div>
