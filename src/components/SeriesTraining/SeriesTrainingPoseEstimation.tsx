...
import '../Training/PoseEstimation.css';
...
const SeriesTrainingPoseEstimation: React.FC<PoseEstimationProps> = ({
  setPoseLandmarks,
}) => {
      ...
      {isMediaPipeLoading ? (
        ...
        <React.Fragment>
          <div className="h-full w-full relative">
            <canvas
              className="pose-estimation-canvas object-cover h-full w-full"
              ref={canvasRef}
...
export default SeriesTrainingPoseEstimation;
