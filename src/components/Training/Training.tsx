...
import { Instruction, LeftHandLeftPunch, LeftHandRightPunch, LeftJabInstruction, LeftLegLeftKick, LeftLegRightKick, RightHandLeftPunch, RightHandRightPunch } from './Instruction';
...
const Training = () => {
  ...
  useEffect(() => {
    if (isMoveEnded) {
      setInstruction(LeftLegRightKick);
